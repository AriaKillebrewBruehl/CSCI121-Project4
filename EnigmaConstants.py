...
ROTOR_PERMUTATIONS = [
    "EKMFLGDQVZNTOWYHXUSPAIBRCJ",  # Permutation for slow rotor  (0)    
    "AJDKSIRUXBLHWTMCQGZNPYFVOE",  # Permutation for medium rotor  (1)  
    "BDFHJLCPRTXVZNYEIWGAKMUSQO",  # Permutation for fast rotor   (2)
    "ESOVPZJAYQUIRHXLNFTGKDCMWB", # Permutation for additional rotor (3)
    "VZBRGITYUPSDNHLXAWMJQOFECKX"   # Permutation of additional rotor (4)
]
